...
class Atri:
	...
	@property
	def Overlay1(self):
		self._getter_access_tracker["Overlay1"] = {}
		return self._Overlay1
	@Overlay1.setter
	def Overlay1(self, new_state):
		self._setter_access_tracker["Overlay1"] = {}
		global default_state
		self._Overlay1 = Overlay(new_state, default_state["Overlay1"])
